...
Unpause's logo, craft illustrations, and sample text were created for this repository. Sample projects do not represent customer content, founder biography, or traction. Research quotations and external imagery are not bundled into the app.

Full font licenses are copied into `assets/licenses/` for distribution with the font files.
